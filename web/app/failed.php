...
<body>
<div class="wrap">
<div class="position">&nbsp;当前位置:&gt;&gt; 未通过申请</div>
 <div class="content">
      <table width="768" class="s s_grid">
      	<tr>
          <td colspan="7" class="caption">未通过申请</td>
        </tr>
            <tr>
              <th>二级域名</th>
              <th>域名</th>
            ...
            <?
		$query=$db->query("select * from regroom where state=2");
		...
		?>
            <tr>
              ...
              <td>
			    <?
				echo "通用：".$row['ip']."<br>";
				$que=$db->query("select * from aclips where status=2 and regroom=".$row['id']);
