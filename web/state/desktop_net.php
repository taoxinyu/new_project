...
$ifnum = $_GET['ifnum'];
$ifname = $_GET['ifname'] ? $_GET['ifname'] : "";
$scale_type = "follow";
$nb_plot = 120;
$time_interval = 1;
...
$attribs['legend'] = "fill=\"#ffffff\" font-family=\"SimSun,Tahoma, Verdana, Arial, Helvetica, sans-serif\" font-size=\"6\"";
...
preserveAspectRatio="none" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" onload="init(evt)">
	<g id="graph">
		...
		<text id="graph_in_lbl" x="5" y="8" <?php echo $attribs['in']?>>接收</text>
		<text id="graph_out_lbl" x="5" y="16" <?php echo $attribs['out']?>>发送</text>
		...
		<text id="switch_unit" x="<?php echo $width*0.55?>" y="5" <?php echo $attribs['switch_unit']?>></text>
		<text id="switch_scale" x="<?php echo $width*0.55?>" y="11" <?php echo $attribs['switch_scale']?>></text>
		<text id="datetime" x="<?php echo $width*0.33?>" y="5" <?php echo $attribs['legend']?>> </text>
		<text id="graphlast" x="<?php echo $width*0.55?>" y="17" <?php echo $attribs['legend']?>></text>
