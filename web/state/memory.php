...
<body>
<div class="wrap">
<div class="position">&nbsp;当前位置:&gt;&gt; 内存监控 </div>
<div class="content"> 
<div class="box_tab box">
	<div class="caption">内存监控</div>
		...
		<dd class="on"><img src="../hot/system/mem-hour.png"></dd>
		<dd><img src="../hot/system/mem-6h.png"></dd>
		<dd><img src="../hot/system/mem-day.png"></dd>
		<dd><img src="../hot/system/mem-week.png"></dd>
		<dd><img src="../hot/system/mem-month.png"></dd>
		<dd><img src="../hot/system/mem-year.png"></dd>
	    </dl>
	</div>
</div>
</div>
