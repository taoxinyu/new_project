...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="28" align="left" background="../images/bg_topbg.gif">&nbsp;当前位置:&gt;&gt; DNS解析日志 </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td><table width="768" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#82C4E8">
      <tr>
        <td height="25" colspan="3" align="center" background="../images/abg2.gif" bgcolor="#D7F5F9" class="greenbg">DNS日志</td>
      </tr>
      ...
      exec("sed -n '".$pagem.",".($starnum)."p' ".$bindquerylog,$ipconfig,$rc);
