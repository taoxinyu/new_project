...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="28" align="left" background="../images/bg_topbg.gif">&nbsp;当前位置:&gt;&gt; 日志删除 </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td><table width="768" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#82C4E8">
      <tr>
        <td width="742" height="25" align="center" background="../images/abg2.gif" bgcolor="#D7F5F9" class="greenbg">日志删除</td>
      </tr>
     ...
     <form id="dnslogdel" name="dnslogdel" method="get" action="logdel.php"> <tr>
        <td height="25" align="left" background="../images/abg.gif" bgcolor="#D7F5F9" class="graybg">
          按日期删除DNS解析日志:
              <label>
              <input name="start" type="text" id="start" size="13" ondblclick="calendar()" value="<?echo $_GET['start']?>" title="双击弹出日期选择" />
              </label>
      <label>
 到
 <input name="end" type="text" id="end" size="13" ondblclick="calendar()" value="<?echo $_GET['end']?>" title="双击弹出日期选择" />      
 <input name="op" type="hidden" id="op" value="deldnsdate" /><input type="submit" name="Submit2" value="删除本时间段的日志文件" onclick="javascript:return   confirm('要删除选择的日期段里DNS解析日志吗？');"/>
      ...
      <tr>
        <td height="25" align="left" background="../images/abg.gif" bgcolor="#D7F5F9" class="graybg">
          按日期删除操作日志:
              <label>
      <input name="start2" type="text" id="start2" size="13" ondblclick="calendar()" value="<?echo $_GET['start2']?>" title="双击弹出日期选择" />
      </label>
      <label> 到
        <input name="end2" type="text" id="end2" size="13" ondblclick="calendar()" value="<?echo $_GET['end2']?>" title="双击弹出日期选择" />
      ...
      <form id="loginlog" name="loginlog" method="get" action="logdel.php"><tr>
        <td height="25" align="left" bgcolor="#FFFFFF">
          按日期删除登陆日志:
            <label>
      <input name="start3" type="text" id="start3" size="13" ondblclick="calendar()" value="<?echo $_GET['start3']?>" title="双击弹出日期选择" />
      </label>
      <label> 到
        <input name="end3" type="text" id="end3" size="13" ondblclick="calendar()" value="<?echo $_GET['end3']?>" title="双击弹出日期选择" />
