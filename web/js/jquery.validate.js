...
$.extend($.validator, {
	...
	methods: {
		...
		rangelw: function( value, element, param ) {
			return this.optional(element) || ( value >= param[0] && value <= param[1] || value>=param[2] && value<=param[3]);
		},
